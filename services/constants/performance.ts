export const PERFORMANCE_QUERY_KEYS = {
  ...
  APPRAISERS: "performance-appraisers",
  APPRAISER: "performance-appraiser",
  CREATE_APPRAISER: "performance-create-appraiser",
  UPDATE_APPRAISER: "performance-update-appraiser",
  DELETE_APPRAISER: "performance-delete-appraiser",
} as const;
...
export const GET_APPRAISERS = PERFORMANCE_QUERY_KEYS.APPRAISERS;
export const GET_APPRAISER = PERFORMANCE_QUERY_KEYS.APPRAISER;
export const CREATE_APPRAISER = PERFORMANCE_QUERY_KEYS.CREATE_APPRAISER;
export const UPDATE_APPRAISER = PERFORMANCE_QUERY_KEYS.UPDATE_APPRAISER;
export const DELETE_APPRAISER = PERFORMANCE_QUERY_KEYS.DELETE_APPRAISER;
