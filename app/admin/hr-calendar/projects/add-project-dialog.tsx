...
import { useCreateProject } from "@/services/hooks/calendar/projects"
...
export function AddProjectDialog({ isOpen, onClose }: AddProjectDialogProps) {
  ...
  const [formData, setFormData] = useState<ProjectFormData>(defaultFormState)
  ...
  const isLoading = createProjectMutation.isPending || isSubmitting
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="IPPIS System Upgrade"
                        disabled={isLoading}
                      />
