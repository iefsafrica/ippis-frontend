...
export function TravelRequestDetails({ event, onClose }) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <Badge className="bg-pink-100 text-pink-800">Travel Request</Badge>
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="font-semibold">Travel Type:</div>
          <div className="col-span-2">{event.travelType}</div>
        </div>

        <div className="grid grid-cols-3 gap-2">
          <div className="font-semibold">Destination:</div>
          <div className="col-span-2">{event.destination}</div>
        </div>
