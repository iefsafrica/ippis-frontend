...
//     review: { label: "Under Review", className: "bg-yellow-100 text-yellow-800 hover:bg-yellow-100" },
...
//     label: "Status",
//     type: "select",
//     options: RECRUITMENT_CMS_STATUS_OPTIONS,
//     required: true,
//   },
//   {
//     name: "slug",
...
//                     {RECRUITMENT_CMS_STATUS_OPTIONS.map((option) => (
//                       <SelectItem key={option.value} value={option.value}>
//                         {option.label}
//                       </SelectItem>
//                     ))}
