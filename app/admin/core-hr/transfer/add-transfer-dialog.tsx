...
import type { CreateTransferPayload } from "@/types/hr-core/transfer"
...
export function AddTransferDialog({ 
  ...
  const handleSelectChange = (name: keyof CreateTransferPayload, value: string) => {
    setFormData((prev) => ({ ...prev, [name]: value }))
  ...
  const validateForm = () => {
    ...
    if (new Date(formData.effective_date) < new Date()) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const loadingToast = toast.loading("Creating transfer record...")
    ...
    try {
      ...
      toast.error("Failed to create transfer record. Please try again.", {
        id: loadingToast,
        duration: 4000,
      })
    } finally {
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <DialogDescription className="text-gray-600 mt-1">
                  Create a transfer request for an employee
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
            ...
            <div className="space-y-8">
              ...
              <div className="pt-6 border-t border-gray-200">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="from_location" className="text-sm font-medium text-gray-700 mb-2 block">
                        Current Location *
                      </Label>
                      <Select
                      ...
                      {errors.from_location && (
                        <p className="text-sm text-red-600 mt-2">{errors.from_location}</p>
                      )}
                    </div>
